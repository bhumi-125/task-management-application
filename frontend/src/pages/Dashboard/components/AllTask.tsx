...
const AllTask = () => {
    ...
    return (
        <>
            <div className="mb-3">
                <h1>All Task ({taskList.length})</h1>
            </div>
            <div className="flex-wrap d-flex justify-content-center align-items-center">
                {
                    taskList.length > 0 ? (
                        taskList.map((cur: Task, i) => {
                            return (
                                <div key={i} className="card border py-4 px-4 mx-2 my-2 col-sm-12 col-md-6 col-lg-3 ">
                        ...
                        <h1 className="text-center text-decoration-underline">No Task Available</h1>
                    )
                }
            </div>
        </>
